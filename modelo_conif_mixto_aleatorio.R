...
# Cálculo de los coeficientes del modelo, resultados del entrenamiento y la validación para modelo excluyendo píxeles = 0 (líneas 221 - 327)
# Generación de cartografía (líneas 328 - 353)
...
# EXPORTAR PARCELAS DE ENTRENAMIENTO Y VALIDACION
...
# parcelas seleccionadas en la validación para los modelos 6 y 7
...
#parcelas_coincidentes <- parcelas_validacion %>%
#filter(IDPLOTS %in% parcelas_sinout_ND$IDPLOTS)
